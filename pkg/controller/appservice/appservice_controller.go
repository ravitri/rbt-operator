...
import (
	...
	rbtv1alpha1 "github.com/ravitri/rbt-operator/pkg/apis/rbt/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &rbtv1alpha1.Appservice{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &rbtv1alpha1.Appservice{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileAppservice) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &rbtv1alpha1.Appservice{}
...
func newPodForCR(cr *rbtv1alpha1.Appservice) *corev1.Pod {
